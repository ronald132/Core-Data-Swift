...
class MainVC : UIViewController, UITableViewDataSource, UITableViewDelegate, NSFetchedResultsControllerDelegate{
    ...
    func generateData(){
        ...
        item.price = 1800
        item.details = "I can't wait until the Sepetember event, I hope they release new MBP"
        ...
        item3.price = 110000
        item3.details = "This is a beautiful car and one day I will own it. Just you wait"
